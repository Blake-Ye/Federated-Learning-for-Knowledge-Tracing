...
from client import test_loader, generate_client_fn, train_loader,dataset_name,model_name
...
results_dir = "federated_learning"
...
strategy = fl.server.strategy.FedAvg(
    ...
    fraction_fit=0.33,  # Select 33% of clients for training per round (2 clients)
    fraction_evaluate=0.33,  # Select 33% of clients for evaluation per round (2 clients)
